% Instruções:  [ Tudo está configurado! ]
% Apenas necessitamos de mexer neste documento para fazer "enable" de novos capítulos e referencias usadas. Isto significa que: 

% ---> Apenas necessitamos de criar novos documentos dentro da pasta "chapters" (Ex.: chapter3.tex) e adiciona-los a este documento (que é o nosso "main"), na secção "START OF THESIS TEXT".
% ---> Apenas necessitamos de fazer adicionar as referencias usadas na secção "PRINT ALL USED REFERENCES"
% ---> DEVEMOS: adicionar novas coisas ao glossário (glossary.tex).
...
%\addtolength{\paWrskip}{0.5\baselineskip}
\linespread{1.5}
...
\nocite{*} %so caso queira que aparecem ate as referencias nao utilizadas
\endgroup
